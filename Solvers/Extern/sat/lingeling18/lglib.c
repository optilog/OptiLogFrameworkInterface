/*-------------------------------------------------------------------------*/
/* Copyright 2010-2017 Armin Biere Johannes Kepler University Linz Austria */
/*-------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------*/
#define NLGLYALSAT undefined
#define NLGLDRUPLIG undefined
...
{
  const int verbose = lgl->opts->verbose.val;
  const char * res;
  size_t len;
  FILE * in;
  int clin;
